...
import { CheckCircle, List, Settings, LogOut, X, Menu } from 'lucide-react';
...
function TeacherDashboard() {
  ...
  // Effect to save the active section to localStorage
  useEffect(() => {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        if (!currentUser || !(currentUser.labels?.includes('teacher') || currentUser.prefs?.role === 'teacher')) {
          navigate('/');
        } else {
          setUser(currentUser);
        }
